...
class block_add_blocks extends block_base {
    ...
    /**
     * Do not allow multiple instances of this block in same page.
     *
     ...
     *
     * @return stdObject A select box with all blocks that can be added to the current page, if the user is editing.
     */
