...
$string['configrestoreequalizenumsections'] = 'Equalize the number of sections of destination course to match the number of sections on source course.';
...
$string['equalizenumsections'] = 'Equalize number of sections';
