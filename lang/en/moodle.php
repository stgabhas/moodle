...
$string['guest'] = 'Guest';
$string['guestaccess'] = 'Show only courses which allow guests to enter';
$string['guestaccessonly'] = 'Showing only courses which allow guests to enter. Click here to show all courses.';
$string['guestaccessany'] = 'Showing all courses. Click here to show only courses which allow guests to enter.';
