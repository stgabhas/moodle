...
$string['auth_dbconnecting'] = "Connecting to remote database server...";
$string['auth_dbcountrecords'] = 'Got {$a} users from remote database...';
$string['auth_dbcreatingtemptable'] = "Creating temporary table";
...
$string['auth_dbdownloadingusers'] = 'Downloading users from external database';
$string['auth_dbgotnousers'] = 'No users were found on remote database. Aborting.';
...
$string['auth_dbinvalidemail'] = 'Found invalid email {$a->email} for user {$a->username}';
$string['auth_dbname'] = 'Name of the database itself';
$string['auth_dbname_key'] = 'DB name';
$string['auth_dbnoupdatestobedone'] = "No updates to be done";
$string['auth_dbnouserentriestoremove'] = "No user entries to be removed";
$string['auth_dbnouserentriestoadd'] = "No user entries to be addedd";
...
$string['auth_dbsuccess'] = 'Auth db sync terminated successfully';
...
$string['auth_dbuserentriestorevive'] = "User entries to be revived: {\$a}";
$string['auth_dbupdatingentries'] = "Updating user entries...";
