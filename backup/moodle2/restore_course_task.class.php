...
// Protected API starts here
    ...
    protected function define_settings() {
        ...
        $fullname = new restore_course_generic_text_setting('course_fullname', base_setting::IS_TEXT, $this->get_info()->original_course_fullname,
                                base_setting::VISIBLE, base_setting::LOCKED_BY_PERMISSION);
        ...
        $keep_enrols = new restore_course_generic_setting('keep_roles_and_enrolments', base_setting::IS_BOOLEAN, true,
                                backup_setting::VISIBLE, backup_setting::LOCKED_BY_CONFIG);
        ...
        $overwrite = new restore_course_overwrite_conf_setting('overwrite_conf', base_setting::IS_BOOLEAN, true,
                                backup_setting::VISIBLE, backup_setting::LOCKED_BY_CONFIG);
