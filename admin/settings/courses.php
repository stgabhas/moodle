...
if ($hassiteconfig or has_any_capability($capabilities, $systemcontext)) {
    ...
    $temp->add(new admin_setting_configcheckbox_with_lock('backup/restore_equalize_numsections', new lang_string('equalizenumsections','backup'), new lang_string('configrestoreequalizenumsections','backup'), array('value'=>0, 'locked'=>0)));
    $ADMIN->add('backups', $temp);
